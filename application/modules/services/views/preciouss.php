...
$gems = [
    [
        ...
        "desc"  => "Wisdom • Prosperity • Jupiter Power"
    ],
    [
        "img"   => "d2.png",
        "name"  => "BLUE SAPPHIRE",
        "title" => "BLUE SAPPHIRE | NEELAM",
        "desc"  => "Discipline • Karma • Saturn Energy"
    ],
    [
        "img"   => "d3.png",
        "name"  => "OPAL",
        "title" => "OPAL",
        "desc"  => "Luxury • Creativity • Venus Power"
    ],
    [
        "img"   => "d4.png",
        "name"  => "GARNET",
        "title" => "GARNET",
        "desc"  => "Strength • Protection • Vitality"
    ],
    [
        "img"   => "d5.png",
        "name"  => "RED CORAL",
        "title" => "RED CORAL | MOONGA",
        "desc"  => "Courage • Mars Energy • Confidence"
    ],
    [
        "img"   => "d6.png",
        "name"  => "CAT’S EYE",
        "title" => "CAT’S EYE | LEHSUNIA",
        "desc"  => "Protection • Focus • Ketu Power"
    ],
    [
        "img"   => "d7.png",
        "name"  => "HESSONITE",
        "title" => "HESSONITE | GOMED",
        "desc"  => "Stability • Rahu Control • Growth"
    ],
    [
        "img"   => "d8.png",
        "name"  => "PEARL",
        "title" => "PEARL | MOTI",
        "desc"  => "Peace • Mind • Moon Energy"
    ],
    [
        "img"   => "d9.png",
        "name"  => "TIGER EYE",
        "title" => "TIGER EYE",
        "desc"  => "Confidence • Protection • Power"
    ]
];
?>
        ...
        <?php foreach ($gems as $gem): ?>
            <div class="col-6 col-md-4">
                ...
                <div class="lux-footer">
                    <a href="https://wa.me/917877040552?text=Hello%20I%20am%20interested%20in%20<?= urlencode($gem['name']); ?>%20gemstone"
                       target="_blank"
                       class="lux-btn">
                        SHOP NOW
                    </a>
...
/* SECTION */
.lux-section{position:relative;overflow:hidden;padding:0 50px;}
.lux-particles{position:absolute;inset:0;pointer-events:none;z-index:0;}
