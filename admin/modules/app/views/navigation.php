...
<div id="hoeapp-container" hoe-lpanel-effect="default">
	<aside id="hoe-left-panel" hoe-position-type="absolute">
		...
		<ul class="nav panel-list">
			...
			<li class="sidepadding"><a href="#/workers" accesskey="w"><i class="fa fa-credit-card"></i>
					<span class="menu-text">Workers</span><span class="selected"></span></a>
			</li>

			<li class="sidepadding"><a href="#/transactions" accesskey="t"><i class="fa fa-credit-card"></i>
					<span class="menu-text">Transactions</span><span class="selected"></span></a>
			</li>

			<li class="sidepadding"><a href="#/records" accesskey="r"><i class="fa fa-credit-card"></i>
