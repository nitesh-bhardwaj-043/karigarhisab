	...
	<div class="table_horizontal">
		<div class="row">
			...
			<div class="col-xs-5 col-md-3 text-right">
				<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#workersModal">
					Add Worker
				</button>
			</div>
		</div>
			...
			<table class="table table-hover">
				...
				<tbody>
					<tr dir-paginate="y in datadb | filter: search_text | itemsPerPage: 10">
						<td>{{$index+1}}</td>
						<td>{{y.name}}</td>
						<td><img src="<?= base_url('assets/uploads/workers/') ?>{{y.image}}" height="50px" /></td>
						<td>
...
<div class="modal fade" id="workersModal" tabindex="-1" role="dialog" aria-labelledby="workersModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="workersModalLabel">Add Worker</h4>
			</div>
